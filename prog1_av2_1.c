...
int main()
{
    ...
    printf("\nOlá, meu nome é Felipe Felix e este programa pode ser visto no seguinte endereço do github: https://github.com/FelipeFxOC/trabalhoAv2/blob/master/prog1_av2_1.c\n");
